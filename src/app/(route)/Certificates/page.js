  ...
  return (
    <>
      ...
      <div className={styles.card}>
        ...
        <p>
          <span className={styles.title}>Description</span>: I possess a Job-Focused
          Professional Communication Certificate, emphasizing my strong
          communication skills and readiness for the professional world. This
          certification underscores my ability to effectively convey ideas and
          collaborate within the workplace.
        </p>
        <p>
          <a
            target="_blank"
